  ...
  return (
    <Container fluid className="support-content">
      ...
      <p>
        ...
        student body elections. If you would like to provide financial support,
        please Venmo <span className="venmo-tag">@ssaucsd</span>. Thank you for
        helping us spread our love of classical music with the UCSD community!
      </p>
    </Container>
  );
};
